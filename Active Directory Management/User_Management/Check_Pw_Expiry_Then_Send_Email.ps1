...
param(
    ...
    [ValidateNotNull()]
    [string]$from="xxxx@fromaddress.com.au",
    [Parameter(Position=3)]
    [switch]$logging=$True,
    # Log File Path
    [Parameter(Position=4)]
    [string]$logPath = "C:\Scripts\Logfiles",
    # Testing Enabled
    ...
    [string]$testRecipient="JohnDoe@Email.com",
    # Output more detailed status to console
    [Parameter(Position=7)]
    [switch]$status,
    # Log file recipient
    [Parameter(Position=8)]
    [string]$reportto="JohnDoe@Email.com",
    # Notification Interval
    [Parameter(Position=9)]
    [array]$interval= @(1,2,3,4,5,6,7,10,14,21,30),
    # Set OU
    [Parameter(Position=10)]
    $ou = "OU=xx,OU=xx,OU=xx,DC=xx,DC=xx,DC=xx"
)
###################################################################################################################
$start = [datetime]::Now
...
$users = get-aduser -filter {(Enabled -eq $true) -and (PasswordNeverExpires -eq $false)} -SearchBase $ou -properties Name, PasswordNeverExpires, PasswordExpired, PasswordLastSet, EmailAddress | where { $_.passwordexpired -eq $false }
# Count Users
...
<table style="margin:0 auto; width: 100%;">
    <tr>
        <th style="background-color:#42cbf5; padding:10px 0;">
            <span style="color:#FFF; font-size:60px; font-family:Arial Black, sans-serif;">Bayswater </span>
            <span style="color:#FFF; font-size:60px; font-family:Tahoma, sans-serif; font-weight:normal;">PS</span>
        </th>
    </tr>
    <tr>
        <td>
            <p style="font-family:sans-serif; padding: 20px;">
                Dear $name,<br><br>
                Your <b style="color:#42cbf5;font-size:22px;">Bayswater PS </b> Password will expire in <b style="color:#42cbf5;font-size:22px;">$messageDays</b> days.<br><br>
                You use this password to login to your staff laptop, school computers & Compass.<br><br>
                To reset your password: Press <b style="color:#42cbf5;font-size:15px;">CTRL-ALT-DELETE</b> <i>(simultaneously)</i> when you are logged into your staff laptop or a school computer - and click <b style="color:#42cbf5;font-size:15px;">'Change Password'</b>.<br><br>
                If you're using your staff laptop to reset your password - it can only be done while on school premises.
            </p>
        </td>
    </tr>
    <tr>
        <td>
            <p style="font-family:sans-serif; padding: 5px 20px 5px 20px; border-bottom: 1px solid #A2A2A2;">
                <b>Please Note:</b><br>
                If you don't change your password and it expires - you will lose access to Compass, your laptop, and school computers <i>(until it is reset)</i>.<br><br>
            </p>
        </td>
    </tr>
    <tr>
        <td>
            <p style="font-family:sans-serif; padding: 5px 20px 20px 20px;">
    ...
    <tr>
        <th style="width:100%; height:40px; background-color:#42cbf5;"></th>
    </tr>
</table>
